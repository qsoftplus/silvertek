        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4 mb-16">
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
               {/* Social connections */}
               <a href="#" className="h-10 w-10 rounded-full bg-slate-900 flex items-center justify-center text-white hover:bg-[#1877F2] transition-colors duration-300 shadow-md ring-2 ring-white">
                 <Facebook size={18} />
               </a>
               <a href="#" className="h-10 w-10 rounded-full bg-slate-900 flex items-center justify-center text-white hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] transition-all duration-300 shadow-md ring-2 ring-white">
                 <Instagram size={18} />
               </a>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <h4 className="text-black font-extrabold text-lg uppercase tracking-wide">Headquarters</h4>
